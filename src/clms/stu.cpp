...
namespace clms {
	namespace stu {
		...
		void clms::stu::stu_function(string& stu_id, string& stu_name)
		{
			while (true)
			{
				system("cls");
		...
		void clms::stu::request_appointment(string& stu_id, string& stu_name)
		{
			system("cls");
		...
		void clms::stu::check_self_appointment_status(string& stu_name)
		{
			system("cls");
		...
		void clms::stu::view_appointments()
		{
			system("cls");
			cout << "所有预约信息如下：" << endl;
		...
		void clms::stu::cancel_self_appointment(string& stu_name)
		{
			system("cls");
			cout << "所有可取消的预约信息如下：\n"
				<< "注：只有审核中和预约成功的才能取消"
